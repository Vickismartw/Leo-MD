...
exports.groupsg = async (
  ...
  try {
    ...
    let _0x33935f = asta_grop.decodeJid(leo_grop.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let asta_bot = {
      ...group_sss,
    };
    leo_bot.chat = leo_bot.jid = leo_bot.from = group_sss.id;
    leo_bot.user = leo_bot.sender = Array.isArray(group_sss.participants)
      ? group_sss.participants[0]
      : "xxx";
    leo_bot.name = await leo_grop.getName(leo_bot.user);
    leo_bot.userNum = leo_bot.senderNum = leo_bot.user.split("@")[0];
    leo_bot.time = getTime("h:mm:ss a");
    leo_bot.date = getTime("dddd, MMMM Do YYYY");
    leo_bot.action = leo_bot.status = group_sss.action;
    leo_bot.isCreator = [
      _0xbacc49,
      ...Astro,
      ...global.sudo?.split(","),
    ...
    leo_bot.isAstro = [...Astro]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(asta_bot.user);
    leo_bot.fromMe = leo_bot.isAstro
      ? true
      : areJidsSameUser(leo_bot.user, _0x33935f);
    if (leo_bot.action === "remove" && leo_bot.fromMe) {
      return;
    }
    leo_bot.astaBot = [...Astro]
    ...
    ].includes(leo_bot.chat);
    leo_bot.isGroup = leo_bot.chat.endsWith("@g.us");
    if (leo_bot.isGroup) {
      leo_bot.metadata = await leo_grop.groupMetadata(leo_bot.chat);
      gcs[leo_bot.chat] = leo_bot.metadata;
      leo_bot.admins = leo_bot.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      leo_bot.isAdmin = !!leo_bot.admins.find(
        (_0x859f83) => _0x859f83.id === leo_bot.user
      );
      leo_bot.isBotAdmin = !!leo_bot.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    leo_bot.kick = asta_bot.remove = (_0x48f5af = leo_bot.user) =>
      leo_grop.groupParticipantsUpdate(asta_bot.chat, [_0x48f5af], "remove");
    leo_bot.add = (_0x422af3 = leo_bot.user) =>
      leo_grop.groupParticipantsUpdate(leo_bot.chat, [_0x422af3], "add");
    leo_bot.promote = (_0x3d0644 = leo_bot.user) =>
      leo_grop.groupParticipantsUpdate(leo_bot.chat, [_0x3d0644], "promote");
    leo_bot.demote = (_0x37d435 = leo_bot.user) =>
      leo_grop.groupParticipantsUpdate(leo_bot.chat, [_0x37d435], "demote");
    leo_bot.getpp = async (_0x577c8f = leo_bot.user) => {
      try {
        return await leo_grop.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    leo_bot.sendMessage = async (
      _0x5a0f4b = leo_bot.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await leo_grop.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    asta_bot.sendUi = async (
      _0x107cb3 = leo_bot.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
    ...
    asta_bot.error = async (
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        leo_bot.chat !== leo_bot.botNumber
      ) {
        await asta_grop.sendMessage(leo_bot.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await leo_grop.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [leo_bot.user],
          },
          {
    ...
    asta_bot.send = async (
      ...
      _0xb61629 = "leo",
      _0x919f26 = "",
      _0x3ccfb1 = leo_bot.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : leo_bot.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await leo_grop.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
    ...
    asta_bot.sendPoll = async (
      ...
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = leo_bot.jid
    ) => {
      return await leo_bot.send(
        _0x188344,
        {
          values: _0x4bb725,
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("LEOMD");
    ...
    if (_0x1d4327) {
      ...
      if (_0x2d6cd0.quoted.message) {
        ...
        _0x2d6cd0.quoted.isBaileys = _0x2d6cd0.quoted.isBot =
          ...
          _0x2d6cd0.quoted.id?.startsWith("LEOMD") ||
  ...
  _0x2d6cd0.Johnleo = (_0xd6e77d = _0x2d6cd0.sender) =>
    [...Astro]
